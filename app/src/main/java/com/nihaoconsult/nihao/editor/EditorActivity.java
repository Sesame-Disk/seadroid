package com.nihaoconsult.nihao.editor;
...
import com.nihaoconsult.nihao.editor.widget.HorizontalEditScrollView;
...
//            showSaveDialog();
    ...
    protected void onResume() {
        super.onResume();
        if (!com.nihaoconsult.nihao.util.Utils.isServiceRunning(EditorActivity.this, "com.seafile.seadroid2.monitor.FileMonitorService")) {
