package com.nihaoconsult.nihao.account.ui;
...
import com.nihaoconsult.nihao.account.Authenticator;
import com.nihaoconsult.nihao.cameraupload.CameraUploadManager;
import com.nihaoconsult.nihao.ui.BaseAuthenticatorActivity;
...
public class SeafileAuthenticatorActivity extends BaseAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra(ARG_SHIB, false)) {
            ...
            android.accounts.Account account = new android.accounts.Account(getIntent().getStringExtra(SeafileAuthenticatorActivity.ARG_ACCOUNT_NAME), com.nihaoconsult.nihao.account.Account.ACCOUNT_TYPE);
