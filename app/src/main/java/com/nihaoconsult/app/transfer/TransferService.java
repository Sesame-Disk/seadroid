package com.nihaoconsult.app.transfer;
...
public class TransferService extends Service {
     ...
     *
     * Note: when deleting all tasks whose state is {@link com.nihaoconsult.app.transfer.TaskState#TRANSFERRING} in the queue,
     * other tasks left will never be executed, because they are all in the {@link com.nihaoconsult.app.transfer.TaskState#INIT} state.
