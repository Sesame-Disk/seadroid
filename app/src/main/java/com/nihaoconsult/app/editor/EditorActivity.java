package com.nihaoconsult.app.editor;
...
import com.nihaoconsult.app.editor.widget.HorizontalEditScrollView;
...
//            showSaveDialog();
    ...
    protected void onResume() {
        super.onResume();
        if (!com.nihaoconsult.app.util.Utils.isServiceRunning(EditorActivity.this, "com.seafile.seadroid2.monitor.FileMonitorService")) {
