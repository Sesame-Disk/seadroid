...
import com.nihaoconsult.app.ui.BaseAuthenticatorActivity;
...
public class SeafileAuthenticatorActivity extends BaseAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra(ARG_SHIB, false)) {
            ...
            android.accounts.Account account = new android.accounts.Account(getIntent().getStringExtra(SeafileAuthenticatorActivity.ARG_ACCOUNT_NAME), com.nihaoconsult.app.account.Account.ACCOUNT_TYPE);
