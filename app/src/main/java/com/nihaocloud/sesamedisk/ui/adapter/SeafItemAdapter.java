...
import com.nihaocloud.sesamedisk.util.GlideApp;
...
public class SeafItemAdapter extends BaseAdapter {
    ...
    /**
     * To refresh downloading status of {@link com.nihaocloud.sesamedisk.ui.fragment.ReposFragment#mListView},
    ...
    private View getRepoView(final SeafRepo repo, View convertView, ViewGroup parent) {
        ...
        viewHolder.action.setOnClickListener(v -> mActivity.showRepoBottomSheet(repo));
    ...
    private View getDirentView(final SeafDirent dirent, View convertView, ViewGroup parent, final int position) {
        ...
        if (actionModeOn) {
            ...
            viewHolder.multiSelect.setOnClickListener(v -> {
                if (!mSelectedItemsIds.get(position)) {
                    viewHolder.multiSelect.setImageResource(R.drawable.multi_select_item_checked);
    ...
    /**
     * use to refresh view of {@link com.nihaocloud.sesamedisk.ui.fragment.ReposFragment #mPullRefreshListView}
     * <p>
