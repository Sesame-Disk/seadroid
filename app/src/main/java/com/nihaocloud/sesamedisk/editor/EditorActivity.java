package com.nihaocloud.sesamedisk.editor;
...
import com.nihaocloud.sesamedisk.editor.widget.HorizontalEditScrollView;
...
//            showSaveDialog();
    ...
    protected void onResume() {
        super.onResume();
        if (!com.nihaocloud.sesamedisk.util.Utils.isServiceRunning(EditorActivity.this, "com.seafile.seadroid2.monitor.FileMonitorService")) {
