...
import com.nihaocloud.sesamedisk.account.ui.SeafileAuthenticatorActivity;
...
public class Authenticator extends AbstractAccountAuthenticator {
    ...
    private com.nihaocloud.sesamedisk.account.AccountManager manager;
    ...
    public Authenticator(Context context) {
        ...
        this.manager = new com.nihaocloud.sesamedisk.account.AccountManager(context);
