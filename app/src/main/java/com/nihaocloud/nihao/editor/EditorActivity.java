package com.nihaocloud.nihao.editor;
...
import com.nihaocloud.nihao.editor.widget.HorizontalEditScrollView;
...
//            showSaveDialog();
    ...
    protected void onResume() {
        super.onResume();
        if (!com.nihaocloud.nihao.util.Utils.isServiceRunning(EditorActivity.this, "com.seafile.seadroid2.monitor.FileMonitorService")) {
