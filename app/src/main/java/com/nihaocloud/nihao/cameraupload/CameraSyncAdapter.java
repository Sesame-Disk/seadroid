package com.nihaocloud.nihao.cameraupload;
...
public class CameraSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private com.nihaocloud.nihao.account.AccountManager manager;
